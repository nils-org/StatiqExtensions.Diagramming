# Contributing to StatiqExtensions.Diagramming

First and foremost, thank you! We appreciate that you want to contribute to StatiqExtensions.Diagramming,
...
**Showing support for StatiqExtensions.Diagramming**
...
Don't have time to contribute? No worries, here are some other ways to show your support for StatiqExtensions.Diagramming:

- star the [project][]
- tweet your support for StatiqExtensions.Diagramming
...
- **version**: (required) please note the version of StatiqExtensions.Diagramming you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the StatiqExtensions.Diagramming addin

### Closing issues

The original poster or the maintainers of StatiqExtensions.Diagramming may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of StatiqExtensions.Diagramming
...
[project]: https://github.com/nils-org/StatiqExtensions.Diagramming
